    ...
    menu.append("div").style("margin-top", "30px")
        ...
        .on("click", function () {
            ...
            if (l.length > 1) {
                ...
                var newWaypoint = { addedBy: user.uid, user: o, label: l, vector: cluster.keyValues, notes: n, version: "1.1", recordID: record.metadata.id, sourceFilename: record.metadata.filename }
