import { userDataLoaded, chartWidth, chartHeight, mode3d, waypoints, updateAllCharts, anonymous } from "../pages/map"
import { popUp, popUpremove, addMenu, menuRemove, moveMenu } from "./ui";
import { getRelativeVector, runModel } from "../utils/analysis";
import { addWaypoint, deleteWaypoint, updateWaypoint } from "../utils/database"
import { centroid, clone } from "./functions";
import { node_links } from "./vectors";
import { x_mini } from "./minichart";
import { state, rebuildChart, user } from "../pages/map";
    ...
    menu.append("div").style("margin-top", "30px")
        ...
        .on("click", function () {
            ...
            if (l.length > 1) {
                ...
                var newWaypoint = { userid: user.uid, user: state.userName, label: l, vector: user_point.vector, notes: n, resolution: state.resolution }
