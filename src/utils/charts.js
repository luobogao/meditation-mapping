...
export function updateChartUser(data) {
    ...
    var vectors = getEveryNth(data, 1).map(e => getRelativeVector(e, 60)).filter(e => e != null)
    ...
    menu.append("div").style("margin-top", "30px")
        ...
        .on("click", function () {
            ...
            if (l.length > 1) {
                ...
                var newWaypoint = { userid: user.uid, user: o, label: l, vector: user_point.relative_vector_avg60, notes: n, resolution: state.resolution }
