...
import { uploadCSV, addRecording, user } from "./database";
...
function uploadNewCSV(data) {

    var firstRowTimestamp = data.startTime
    ...
    menu.append("div").style("margin-top", "30px")
        ...
        .on("click", function () {
            ...
            var newRecording = {filename: filename, user: o, notes: n}

            addRecording(newRecording)
                .then((doc) => {
                    console.log("----> Added recording Info" + doc.id)
